...
st.sidebar.image(image, use_container_width=True,width='stretch')
...
model_options = ["ChatGPT-6.0-Beta-Version","GPT-3.0","GPT-o3-mini","GPT-o3-nano","gpt-4.0-turbo","gpt-4o-mini","gpt-5.0","meta-laama""Linear Regression", "Decision Tree", "Random Forest"]
...
#create sidebar for adjusting parameters
st.sidebar.title("Explore Tools") 

#create sidebar for adjusting parameters
st.sidebar.title("Go Pro") 

#create sidebar for adjusting parameters
st.sidebar.title("Download Apps") 
...
st.title("hr-aisolution Enterprise Data - File Uploader")
